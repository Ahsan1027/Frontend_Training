                ...
                <Table className='mt-2 ms-3' style={Styling.RowAdjust}>
                                        ...
                                        <tr key={item._id}>
                                            {headings.map((heading) => (
                                                <td key={heading}>
                                                    ...
                                                    {heading === 'Actions' && (
                                                        <>
                                                            <svg onClick={() => editProducts(item._id)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    {editItemId && (
                        <Edit
                            ...
                            placeholders={placeholders}
                            text='Save'
                            onClose={(thumbnail, title, price, stock, rating, selectedSizes, selectedColors) => {
                                editProductHandler(thumbnail, title, price, stock, rating, selectedSizes, selectedColors, selectedProductId);
                            }}
                            onClose1={() => {
                                setEditItemId(null);
                            }}
